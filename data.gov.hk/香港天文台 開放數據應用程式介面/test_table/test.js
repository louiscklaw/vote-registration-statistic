...
function getTableContentFromJson(json_in){
  console.log(json_in.data)
  console.log(getTbodys(json_in.data))
...
document.querySelector('#table-content').innerHTML = getTableContentFromJson(test_json)

// console.log('table', getTableContentFromJson())
// console.log('test.js')

// console.log(getTableContentFromJson(test_json))